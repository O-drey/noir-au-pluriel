<template>
  <label :for="labelFor">
    ...
    <input
      ...
      "
      class="py-3.5 px-4 border border-gray-300 rounded-sm focus-visible:border-2 focus-visible:ring-offset-2 focus-visible:ring-2 focus-visible:ring-black focus-visible:ring-offset-transparent w-full"
  /></label>
</template>
